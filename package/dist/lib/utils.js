...
async function initEPAForTS(pth) {
    ...
    shelljs_1.default.exec('npm install -D eslint eslint-config-prettier eslint-config-airbnb-base eslint-plugin-prettier eslint-plugin-import eslint-plugin-import-resolver-typescript @typescript-eslint/eslint-plugin prettier eslint-config-airbnb-typescript @typescript-eslint/parser');
...
async function initEPAForJS(pth) {
    ...
    logger_1.logger.info('Installing packages...');
    shelljs_1.default.exec('npm install -D eslint eslint-config-prettier eslint-config-airbnb-base eslint-plugin-prettier eslint-plugin-import prettier');
    shelljs_1.default.exec('npm i --save');
    logger_1.logger.info('Packages installed');
    logger_1.logger.info('Creating .eslintrc.js file');
    const eslintRcTemplate = await promises_1.default.readFile(`${dir_1.rootDir}/templates/javascript/.eslintrc.js`, 'utf8');
    await promises_1.default.writeFile('.eslintrc.js', eslintRcTemplate);
    logger_1.logger.info('Creating prettier.config.js file');
    const prettierRcTemplate = await promises_1.default.readFile(`${dir_1.rootDir}/templates/javascript/prettier.config.js`, 'utf8');
    await promises_1.default.writeFile('prettier.config.js', prettierRcTemplate);
    const eslintIgnoreTemplate = await promises_1.default.readFile(`${dir_1.rootDir}/templates/javascript/.eslintignore`, 'utf8');
    await promises_1.default.writeFile('.eslintignore', eslintIgnoreTemplate);
    logger_1.logger.info('Pushing "fix" script to package.json');
    const packageContent = await promises_1.default.readFile('package.json', 'utf8');
    const packageJSON = JSON.parse(packageContent);
